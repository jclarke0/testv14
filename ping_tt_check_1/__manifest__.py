# -*- coding: utf-8 -*-
{
    'name': 'PING TT Check Layout',
    'version': '1.0',
    'category': 'Accounting/Localizations/Check',
    'summary': 'Print TT Checks',
    'description': """
    
PING CHECK PRINTING MODULE: 
...
- Check on bottom: ADP standard (https://www.checkdepot.net/checks/checkorder/laser_bottomcheck.htm)
    """,
    'website': 'https://www.pingtt.com',
    'depends' : ['ping_account_accountant_check_printing','ping_account_check_printing', 'l10n_us','l10n_us_reports'],
    'data': [
